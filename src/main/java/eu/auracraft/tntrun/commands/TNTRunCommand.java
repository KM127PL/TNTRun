            ...
            if(player.hasPermission("auracraft.tntrun")) {
                if(args.length == 0) {
                    ...
                    switch(args[0]) {
                        ...
                        case "recreate": // tnt recreate
                            Bukkit.getServer().dispatchCommand(sender, "/tnt delete");
                            Bukkit.getServer().dispatchCommand(sender, "/tnt create");
